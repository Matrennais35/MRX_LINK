...
def _covers(dataset: Dataset, plan: MRXPlan, fingerprint: Callable[[MRXPlan], dict]) -> bool:
...
def find_reusable_dataset(datasets: list, plan: MRXPlan, *, fingerprint: Callable[[MRXPlan], dict]) -> Optional[Dataset]:
