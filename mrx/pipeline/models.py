...
any one MRX view — only the *content* a planner puts in it is. It lives
here, not in a view's own planner module, so pipeline code (catalog.py,
router.py) that needs to type/store/compare a plan doesn't have to import
across the pipeline/views boundary.
"""
